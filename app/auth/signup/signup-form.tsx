            ...
            <div className="max-w-sm w-full">
              <div className="mb-8">
                ...
                <Text style={{ color: subtextColor, fontSize: "16px" }}>
                  Let&apos;s get started with your vintage fashion journey
                </Text>
              </div>
          ...
          <div className="relative h-full min-h-screen">
            ...
            <div className="absolute inset-0 flex flex-col justify-end p-12 text-white">
              <div className="max-w-md">
                <Title level={1} className="mb-8" style={{ color: "#ffffff", fontSize: "36px" }}>
                  Discovering the Best Vintage Fashion for Your Style
                </Title>
                <Text className="!text-white text-lg mb-8 block leading-relaxed">
                  Our curated collection brings together timeless vintage pieces and modern comfort...
                </Text>
                <div className="flex flex-wrap gap-3">
                  <div className="flex items-center bg-white/20 backdrop-blur-sm rounded-full px-4 py-2">
                    <div className="w-2 h-2 bg-green-400 rounded-full mr-2" />
                    <Text className="!text-white text-sm font-medium">100% Authentic</Text>
                  </div>
                  <div className="flex items-center bg-white/20 backdrop-blur-sm rounded-full px-4 py-2">
                    <div className="w-2 h-2 bg-blue-400 rounded-full mr-2" />
                    <Text className="!text-white text-sm font-medium">Free shipping worldwide</Text>
                  </div>
                </div>
              </div>
            </div>
